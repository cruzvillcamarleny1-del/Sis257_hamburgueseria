        ...
        <nav class="navbar navbar-expand-lg custom_nav-container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
              <li class="nav-item">
                <router-link class="nav-link" :to="{ path: '/', hash: '#home' }">Home</router-link>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <router-link class="nav-link" :to="{ name: 'producto' }">Productos</router-link>
              </li>
              <li class="nav-item">
            ...
            <div class="user_option">
              ...
              <RouterLink v-if="!authStore.token" to="/login" class="order_online">
                Iniciar Sesión
              </RouterLink>
            </div>
          </div>
